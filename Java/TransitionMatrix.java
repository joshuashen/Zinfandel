        ...
        for (int i=0; i<numStates; i++){
            for (int j=0; j<numStates; j++){
                ...
                //Probability of transitioning from one state to another
                    ...
                    //Normal -> Initial Grid States/Del1/Dup1
                    if (states.get(i) instanceof normalState &&
                       (states.get(j) instanceof InitialGridState || states.get(j) instanceof Deletion1State || states.get(j) instanceof Duplication1State)){
